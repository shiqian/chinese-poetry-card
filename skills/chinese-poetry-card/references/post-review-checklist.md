...
- [ ] Frame, palette, typography hierarchy, footer, feather, and 羽言课堂 placement make the set look like one series.
...
Report five absolute paths. Keep A4 and video exports outside the core five-card directory.
